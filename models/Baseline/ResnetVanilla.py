...
if __name__=='__main__':
    ...
    log_data = "classes-{}_bs-{}_train_src_days-{}_train_trg_days-{}_train_trgenv_days-{}_initlr-{}_num_feat-{}_act_fn-{}_{}".format(
                                                            ...
                                                            activation_fn,
                                                            notes)
    log_dir = os.path.join(repo_path, 'logs/Baselines/Vanilla/{}'.format(log_data))
    checkpoint_path = os.path.join(repo_path, 'checkpoints/Baselines/Vanilla/{}'.format(log_data))
