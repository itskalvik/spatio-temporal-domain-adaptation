...
if __name__ == '__main__':
    ...
    X_train_server, y_train_server, X_test_server, y_test_server = get_trg_data(
        ...
        train_server_days)
    _, _, X_data_office, y_data_office = get_trg_data(
        os.path.join(dataset_path, 'target_office_data.h5'), classes, 0)
    ...
    X_data_office, X_data_office_acc = get_acc_encodings(
        X_data_office, y_data_office)

    print("Final accuracies and shapes: ")
    print("X_train_src:    {:.4f} | {:<12} {:<10}".format(
        X_train_src_acc, str(X_train_src.shape), str(y_train_src.shape)))
    print("X_test_src:     {:.4f} | {:<12} {:<10}".format(
        X_test_src_acc, str(X_test_src.shape), str(y_test_src.shape)))
    print("X_train_trg:    {:.4f} | {:<12} {:<10}".format(
        X_train_trg_acc, str(X_train_trg.shape), str(y_train_trg.shape)))
    print("X_test_trg:     {:.4f} | {:<12} {:<10}".format(
        X_test_trg_acc, str(X_test_trg.shape), str(y_test_trg.shape)))
    print("X_train_conf:   {:.4f} | {:<12} {:<10}".format(
        X_train_conf_acc, str(X_train_conf.shape), str(y_train_conf.shape)))
    print("X_test_conf:    {:.4f} | {:<12} {:<10}".format(
        X_test_conf_acc, str(X_test_conf.shape), str(y_test_conf.shape)))
    print("X_train_server: {:.4f} | {:<12} {:<10}".format(
        X_train_server_acc, str(X_train_server.shape),
        str(y_train_server.shape)))
    print("X_test_server:  {:.4f} | {:<12} {:<10}".format(
        X_test_server_acc, str(X_test_server.shape), str(y_test_server.shape)))
    print("X_data_office:  {:.4f} | {:<12} {:<10}".format(
        X_data_office_acc, str(X_data_office.shape), str(y_data_office.shape)))
